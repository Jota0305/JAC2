...
function Cards() {
  return (
    <div className="w-full h-[410px] bg-white flex justify-center items-center gap-10">
      <div className="mt-10 w-60 bg-violet-300 rounded-lg px-5 py-16 h-60 relative text-center hover:bg-black hover:text-white transition duration-300 ease-in-out transform">
